...
language :  ('#HAI' | '#hai') SPACES? comment? head? (TEXT | paragraph | bold | sound | video | var_create | var_read | break )+ comment? SPACES? ('#KTHXBYE' | '#kthxbye') ;
...
paragraph : ('#MAEK PARAGRAF'| '#maek paragaraf') SPACES? (SPACES |TEXT | bold | italic | list| video| sound | break)+ SPACES? END_O;
...
break: SPACES? ('#GIMMEH NEWLINE' | '#gimmeh newline') SPACES? ;
